    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch(bbUrl).then(res => res.json()).then(resdata => {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                result += `<li class="item"><i class="fa-solid fa-circle-info" style="color:#ffc83d"></i>&nbsp;<span class="datetime">${bbTime}</span>： <a href="https://blog.inetgeek.cn/talks/">${newbbCont}</a></li>`;
            }
